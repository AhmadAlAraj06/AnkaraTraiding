    ...
    <div className="App">
      ...
      <footer class="w3-container w3-padding-32 w3-dark-grey">
        <div class="w3-row-padding">
          ...
          <div class="w3-third">
            <h3>Ankara Traiding Jo</h3>
            <div>
              <h6 className="bottom-infoaaea">Address. :Sahab - Jordan</h6>
            </div>
            <div>
              <h6 className="bottom-infoaaea">Mobile. :+962 7 9627 2623 </h6>
            </div>
            <div>
              <h6 className="bottom-infoaaea">Tel. :+962 6 4021556</h6>
            </div>{" "}
            <div>
              <h6 className="bottom-infoaaea">Fax. :+962 6 4021557</h6>
            </div>
            <div>
              <h6 className="bottom-infoaaea">P.O.Box 330413 Amman 11134 Jordan</h6>
            </div>
            <div>
              <h6 className="bottom-infoaaea">E-mail : followup@artco-jo.com</h6>
            </div>
          </div>
